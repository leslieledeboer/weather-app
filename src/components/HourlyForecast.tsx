...
export default function HourlyForecast({ hourly }: { hourly: HourlyWeather[] }) {
  return (
    <div className="scrollbar-hidden overflow-x-auto flex gap-4 p-4 border border-white/20 rounded-lg text-center text-white/80 bg-slate-900/60 shadow-xl backdrop-blur-md">
      {hourly.map((h, i) => (
